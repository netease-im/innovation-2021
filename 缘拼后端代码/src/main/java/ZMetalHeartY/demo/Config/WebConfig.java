...
public class WebConfig implements WebMvcConfigurer { // 进行WEB配置
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/file/**").addResourceLocations("file:C://tomcatSource/file/");
        registry.addResourceHandler("/UserImg/**").addResourceLocations("file:C://tomcatSource/UserImg/");
        registry.addResourceHandler("/map/**").addResourceLocations("file:C://tomcatSource/map/");
