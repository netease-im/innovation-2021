    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="component-form-group">
                <input type="hidden" name="ag_id" id="agId" value="${flatformAdminGroup.ag_id}">

                <div class="layui-form-item">
                    <label class="layui-form-label">角色名</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="role" placeholder="请输入角色名，格式必须为ROLE_,例如ROLE_ADMIN" value="${flatformAdminGroup.role}"/>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">角色别名</label>
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="ag_name" placeholder="请输入角色别名" value="${flatformAdminGroup.ag_name}"/>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">角色描述</label>
                    <div class="layui-input-block">
                        <input type="text" name="ag_info" lay-verify="agInfo" autocomplete="off" placeholder="请输入角色描述" value="${flatformAdminGroup.ag_info}" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
