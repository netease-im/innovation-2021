	...
	<scroll-view class="content" scroll-y="true">
		...
		<view class="card">
			...
			<view class="order">
				...
				<view class="order_card" v-if="currentAttend.id">
					<image src="../../static/icon/type-icon/fun_icon.png" mode=""></image>
					<view class="order_info">
						<text class="order_address">图书馆学习</text>
						<text class="order_status">正在进行</text>
					</view>
				</view>
			</view>
			<view class="opration">
				<!-- 操作列表 -->
				<view class="opration_cell" v-for="(opration,index) in oprationList" :key="index">
