...
layui.config({
	...
	table.render({
		...
		,url: 'frontUserFollow/listjson?fuId=${fuId}' //修改这个地址，列表查询路径，数据类型见json/table/demo.js
		,toolbar: '#test-table-toolbar-toolbarDemo'
		,title: '用户数据表'
		,cols: [[
			 {filed:'iId',title:'编号', type:'numbers', width:80, fixed: 'left' }
			,{field:'img', title:'关注人头像', width:120,
					templet: function (data) {
						return '<div><img alt="" src=' + 'https://zmetalhearty.com' + data.followedFrontUser.fuImg + '></div>'
					}
				}
			,{field:'img', title:'关注人昵称', width:120,
				templet: function (data) {
					return data.followedFrontUser.fuNickname;
				}
			}
		]]
        ,even: true 
