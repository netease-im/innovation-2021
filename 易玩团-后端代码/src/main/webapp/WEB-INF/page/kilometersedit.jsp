...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">修改公里数</div>
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="component-form-group">
                <input type="hidden" value="${kilometers.id}" name="id"/>
                <div class="layui-form-item">
                    <label class="layui-form-label">公里数</label>
                    <div class="layui-input-block">
                        <input type="number" name="kilometers" lay-verify="title" autocomplete="off" placeholder="请输入公里数" value="${kilometers.kilometers}" class="layui-input">
                    </div>
                </div>
