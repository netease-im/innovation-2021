...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">添加价格方案</div>
            ...
            <form class="layui-form" action="" lay-filter="component-form-group"  enctype="multipart/form-data" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="duration" lay-verify="duration" autocomplete="off" placeholder="请输入期限（天）"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="expense" lay-verify="expense" autocomplete="off" placeholder="请输入价格"
                               class="layui-input">
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("../issue/add", data.field, function (data) {
                // 获取 session
