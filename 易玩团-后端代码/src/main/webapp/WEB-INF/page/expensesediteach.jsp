...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">修改费用</div>
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="component-form-group">
                <input type="hidden" value="${eachissue.id}" name="id"/>

                <div class="layui-form-item">
                    <label class="layui-form-label">每条价格</label>
                    <div class="layui-input-block">
                        <input type="number" name="eachissue" lay-verify="eachissue" autocomplete="off" placeholder="请输入每条价格" value="${eachissue.eachissue}" class="layui-input">
                    </div>
                </div>
