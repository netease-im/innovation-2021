				...
				<div class="layui-form-item">
					<div class="layui-inline">
						<div class="layui-input-inline">
							<input type="text" name="iTitle" id="iTitle" placeholder="请输入标题" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-inline">
						<div class="layui-input-inline">
							<select name="iStatus"  lay-search="">
...
layui.config({
	...
	table.render({
		...
		,cols: [[
			...
			,{field:'img', title:'发帖人昵称', width:150,
			...
			,{field:'img', title:'用户头像', width:120,
				templet: function (data) {
					return '<div><img alt="" src=' + 'https://www.zmetalhearty.com' + data.frontUser.fuImg + '></div>'
				}
			}
			,{field:'iCreateTime', title:'创建时间', width:200}
			, {
			...
			,{field:'iType', title:'类型', width:120, templet: function (data) {
					if (data.iType === 1) {
						return "<span style='color:black'>学习</span>";
					} else if (data.iType === 2) {
						return "<span style='color:black'>出行</span>";
					} else if (data.iType === 3) {
						return "<span style='color:black'>游戏</span>";
					} else if (data.iType === 4) {
						return "<span style='color:black'>吃喝</span>";
					}
				}
			}
