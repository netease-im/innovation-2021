		...
		<scroll-view scroll-y class="scrollView">
			...
			<view class="issue-status" @click="goStatus">
				...
				<view class="status-info">
					<text v-if="currentAttendCount != 0">当前有<text class="info-main">{{currentAttendCount}}</text>个易玩团正在进行中</text>
					<text v-if="currentAttendCount == 0">当前没有易玩团正在进行中</text>
				</view>
				<text class="iconfont icon-xiayiye go-icon"></text>
			</view>
			
			<!-- 热门易玩团 -->
			<k-scroll-list type="all" title="热门易玩团"></k-scroll-list>
