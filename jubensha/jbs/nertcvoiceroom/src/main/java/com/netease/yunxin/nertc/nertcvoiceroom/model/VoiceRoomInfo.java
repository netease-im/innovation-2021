...
public class VoiceRoomInfo implements Serializable {
    ...
    public VoiceRoomInfo(String roomId, String creatorAccount, String name, String thumbnail, int roomType, int audioQuality, int onlineUserCount, String nickname) {
        this.roomId = roomId;
